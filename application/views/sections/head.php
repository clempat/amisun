...
<div id="top_page">
  ...
  <div class="row">
      ...
      <h2>L'entreprise AMISUN</h2><p class="lead">est spécialisée dans l’entretien des générateurs photovoltaïques. <br /> <strong> Maintenance - Nettoyage - Dépannage </strong></p> <?php echo img(array('src' => 'assets/images/qualipv2013.png', 'width' => '100px', 'class' => '')); ?></div></div>
